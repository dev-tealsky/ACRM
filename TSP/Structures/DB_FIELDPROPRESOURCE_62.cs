...
namespace ACRM
{
    public class DB_FIELDPROPRESOURCE_62
    {
        ...
        {
            return "INSERT [dbo].[FieldPropResource] ([id], [text_id], [tooltip_id], [type], [local_flag], [casting_time], [use_count], [regen_time], [life_time], [casting_range], [target_fx_size], [limit_min_level], [limit_max_level], [limit_deva], [limit_asura], [limit_gaia], [limit_fighter], [limit_hunter], [limit_magician], [limit_summoner], [limit_job], [activation_condition], [activation_value1], [activation_value2], [activation2_condition], [activation2_value1], [activation2_value2], [activate_id], [drop_item_id_00], [drop_item_ratio_00], [drop_item_count_min_00], [drop_item_count_max_00], [drop_item_level_min_00], [drop_item_level_max_00], [drop_item_id_01], [drop_item_ratio_01], [drop_item_count_min_01], [drop_item_count_max_01], [drop_item_level_min_01], [drop_item_level_max_01], [script_text], [file_name], [terrain_check], [worldmap_check_type]) VALUES ( @Pid, @Ptext_id, @Ptooltip_id, @Ptype, @Plocal_flag, @Pcasting_time, @Puse_count, @Pregen_time, @Plife_time, @Pcasting_range, @Ptarget_fx_size, @Plimit_min_level, @Plimit_max_level, @Plimit_deva, @Plimit_asura, @Plimit_gaia, @Plimit_fighter, @Plimit_hunter, @Plimit_magician, @Plimit_summoner, @Plimit_job, @Pactivation_condition, @Pactivation_value1, @Pactivation_value2, @Pactivation2_condition, @Pactivation2_value1, @Pactivation2_value2, @Pactivate_id, @Pdrop_item_id_00, @Pdrop_item_ratio_00, @Pdrop_item_count_min_00, @Pdrop_item_count_max_00, @Pdrop_item_level_min_00, @Pdrop_item_level_max_00, @Pdrop_item_id_01, @Pdrop_item_ratio_01, @Pdrop_item_count_min_01, @Pdrop_item_count_max_01, @Pdrop_item_level_min_01, @Pdrop_item_level_max_01, @Pscript_text, @Pfile_name, @Pterrain_check, @Pworldmap_check_type )";
        }

        public static String FromDatabase()
        {
            String rString = "SELECT ";
            foreach (FieldInfo fieldInfo in typeof(DB_FIELDPROPRESOURCE_62).GetFields(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public | BindingFlags.Static))
            {
