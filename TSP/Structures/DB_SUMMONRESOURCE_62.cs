...
namespace ACRM
{
    public class DB_SUMMONRESOURCE_62
    {
        ...
        public static String FromDatabase()
        {
            ...
            foreach (FieldInfo fieldInfo in typeof(DB_SUMMONRESOURCE_62).GetFields(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public | BindingFlags.Static))
            {
